...
namespace GenericWorkflowAPI.Controllers.v1
{
    ...
    public class WorkflowInstanceInputCodeController : GenericOnlyGetAllController<WorkflowInstanceInputCode, WorkflowInstanceInputCodeDto>
    {
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IQueryable<WorkflowInstanceInputCodeDto>> Get([OpenApiParameterIgnore] ODataQueryOptions<WorkflowInstanceInputCodeDto> queryOptions, CancellationToken cancellationToken)
        {
