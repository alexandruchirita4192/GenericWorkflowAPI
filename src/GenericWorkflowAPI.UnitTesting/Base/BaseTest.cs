...
namespace GenericWorkflowAPI.UnitTesting
{
    public class BaseTest
    {
        ...
        {
            // The administrator user is created the same way as data seeding, even though some fields are autogenerated when they're inserted into database
            var admin = new Domain.IdentityUser(SeedDataExtension.AdministratorUserName)
            {
                Id = 1,
                UserName = SeedDataExtension.AdministratorUserName,
                Email = SeedDataExtension.AdministratorEmail,
                EmailConfirmed = true,
