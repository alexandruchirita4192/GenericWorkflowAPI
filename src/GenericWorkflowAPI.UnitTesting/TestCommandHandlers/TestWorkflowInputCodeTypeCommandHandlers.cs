...
namespace GenericWorkflowAPI.UnitTesting
{
    ...
    {
        [TestMethod]
        public async Task GenericGetListCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
        ...
        [TestMethod]
        public async Task GenericGetCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var workflowInputCodeType_includePathList = new List<string> { nameof(WorkflowInputCodeType.Workflow) };
            var uniqueId = DateTime.Now.Ticks;
        ...
        [TestMethod]
        public async Task GenericCreateCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
            ...
            // 2. Act:
            var response = await GenericCreateCommandHandlerExecute<WorkflowInputCodeType, WorkflowInputCodeTypeDto>(
                workflowInputCodeTypeDto,
                user,
                workflowInputCodeType_entityServiceExtraTypes,
                true,
        ...
        [TestMethod]
        public async Task GenericCreateListCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
            ...
            // 2. Act:
            var response = await GenericCreateListCommandHandlerExecute<WorkflowInputCodeType, WorkflowInputCodeTypeDto>(
        ...
        [TestMethod]
        public async Task GenericUpdateCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
            var user = GetDefaultUser();
            ...
            // Set the workflow input code type item data as it would be updated
            ...
            // 2. Act:
            var response = await GenericUpdateCommandHandlerExecute<WorkflowInputCodeType, WorkflowInputCodeTypeDto>(
                workflowInputCodeTypeDto,
                user,
                workflowInputCodeType_entityServiceExtraTypes,
                true,
            ...
            // Print the workflow input code type item
        ...
        [TestMethod]
        public async Task GenericUpdateListCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
            var user = GetDefaultUser();
            ...
            // 2. Act:
            var response = await GenericUpdateListCommandHandlerExecute<WorkflowInputCodeType, WorkflowInputCodeTypeDto>(
                workflowInputCodeTypeDto,
                user,
                workflowInputCodeType_entityServiceExtraTypes,
                true,
        ...
        [TestMethod]
        public async Task GenericDeleteCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
        ...
        [TestMethod]
        public async Task GenericDeleteListCommandHandler_WorkflowInputCodeType_WorkflowDto_ResultIsNotNull()
        {
            // 1. Arrange:
            var uniqueId = DateTime.Now.Ticks;
